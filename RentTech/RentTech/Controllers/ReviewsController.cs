...
namespace RentTech.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,ReviewerId,TechItemId,Text,Rating,ReviewDate")] Review review)
        {
            ...
            ViewData["TechItemId"] = new SelectList(_context.TechItem, "TechItemId", "Condition", review.TechItemId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,ReviewerId,TechItemId,Text,Rating,ReviewDate")] Review review)
        {
